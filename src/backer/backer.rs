...
impl Backer {
    ...
    // TODO
    async fn backup_file_to_qiniu(backup_target: Vec<String>, _cfg: QiniuServer, _archive_file: file::FileInfo) {
    ...
    // TODO
    async fn backup_file_to_aliyun_oss(backup_target: Vec<String>, _cfg: AliyunOssServer, _archive_file: file::FileInfo) {
    ...
    // TODO
    async fn backup_file_to_tencent_oss(backup_target: Vec<String>, _cfg: TencentOssServer, _archive_file: file::FileInfo) {
